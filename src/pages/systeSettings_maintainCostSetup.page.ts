...
export default class MaintainCostSetUpPage {
    ...
    private Elements = {
        ...
        firstRowEdit: "//table[@class='el-table__body']/tbody[1]/tr[1]/td[3]/div[1]/div[1]/button[1]/span[1]/i[1]",
        ...
        deleteLastButton: "//tbody/tr[9]/td[5]/div[1]/div[1]/button[2]/span[1]/i[1]"
    ...
    async verifyEditFunctionality(): Promise<void> {
        ...
        await this.page.locator('//tbody/tr[1]/td[5]/div[1]/div[1]/button[1]/span[1]/i[1]').click();
