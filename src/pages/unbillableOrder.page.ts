...
export default class UnbillableOrderPage {
    ...
    async asst3Details(): Promise<void> {
        ...
        // await this.page.getByText('BO - Burned out').nth(1).click();
        await this.page.locator('xpath=/html/body/div[18]/div/div[1]/ul/li[4]').click();
        await this.page.locator(this.Elements.repairCode3).click();
        await this.page.locator('xpath=/html/body/div[19]/div/div[1]/ul/li[2]').click();
        await this.page.locator(this.Elements.repairLocation3).click();
        await this.page.locator('xpath=/html/body/div[20]/div/div[1]/ul/li[2]').click();
    ...
    async asst4Details(): Promise<void> {
        ...
        await this.page.locator('xpath=/html/body/div[24]/div/div[1]/ul/li[3]').click();
        await this.page.locator(this.Elements.repairCode4).click();
        await this.page.locator('xpath=/html/body/div[25]/div/div[1]/ul/li[3]').click();
        await this.page.locator(this.Elements.repairLocation4).click();
        await this.page.locator('xpath=/html/body/div[26]/div/div[1]/ul/li[1]').click();
    ...
    async asst5Details(): Promise<void> {
        ...
        await this.page.locator('xpath=/html/body/div[6]/div/div[1]/ul/li[1]').click();
        await this.page.locator(this.Elements.repairCode5).click();
        await this.page.locator('xpath=/html/body/div[7]/div/div[1]/ul/li[3]').click();
        await this.page.locator(this.Elements.repairLocation5).click();
        await this.page.locator('xpath=/html/body/div[8]/div/div[1]/ul/li[1]').click();
