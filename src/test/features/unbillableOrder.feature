Feature: Verify functionalities under Un-Billable Work Order
  ...
  @createUnBillableOrderSingleAssetForNormal @sanity @ubwo
  ...
  @createUnBillableOrderSingleAssetVesselSail @sanity @ubwo
  ...
  @createUnBillableOrderSingleAsset4AndGo @sanity @ubwo
  ...
  @createUnBillableOrderSingleAssetPMATraining @sanity @ubwo
  ...
  @createUnBillableOrderFiveAsset @sanity @ubwo
  ...
  @BatchCloseFromToDoList @sanity @ubwo
  Scenario: Verify Batch close screen functionalities for unbillable work order
    Given the admin user is logged into the application
    When the admin navigates to the unbillable work order creation menu
    And enters all the required fields for unbillable work order and selects special shift as vessel sail and clicks on the Draft button
  ...
  Scenario: Search functionality in Inquire Un-billable Work Order screen
    ...
    @weekDaySTNormalShift @sanity @ubwo
  ...
  @weekDaySTNormalShiftSTSecondShift @sanity @ubwo
  ...
  @weekDaySTNormalShiftSTThirdShift @sanity @ubwo
  ...
  @weekDayOTNormalShiftFirstShiftOT @sanity @ubwo
  ...
  @weekDayOTNormalShiftSecondShiftOT @sanity @ubwo
  ...
  @weekDayOTNormalShiftThirdShiftOT @sanity @ubwo
  ...
  @weekDaySTVesselFirstShift @sanity @ubwo
  ...
  @weekDaySTVesselSecondShift @sanity @ubwo
  ...
  @weekDaySTVesselThirdShift @sanity @ubwo
  ...
  @weekDayOTVesselFirstShift @sanity @ubwo
  ...
  @weekDayOTVesselSecondShift @sanity @ubwo
  ...
  @weekDayOTVesselThirdShift @sanity @ubwo
  ...
  @weekDaySTFourAndGoFirstShift @sanity @ubwo
  ...
  @weekDaySTFourAndGoSecondShift @sanity @ubwo
  ...
  @weekDaySTFourAndGoThirdShift @sanity @ubwo
  ...
  @weekDayOTFourAndGoFirstShift @sanity @ubwo
  ...
  @weekDayOTFourAndGoSecondShift @sanity @ubwo
  ...
  @weekDayOTFourAndGoThirdShift @sanity @ubwo
  ...
  @weekDaySTPMATrainingFirstShift @sanity @ubwo
  ...
  @weekDaySTPMATrainingSecondShift @sanity @ubwo
  ...
  @weekDaySTPMATrainingThirdShift @sanity @ubwo
  ...
  @weekDayOTPMATrainingFirstShift @sanity @ubwo
  ...
  @weekDayOTPMATrainingSecondShift @sanity @ubwo
  ...
  @weekDayOTPMATrainingThirdShift @sanity @ubwo
  ...
  @weekEndSTNormalShiftFirstShift @sanity @ubwo
  ...
  @weekEndSTNormalShiftSecondShift @sanity @ubwo
  ...
  @weekEndSTNormalThirdShift @sanity @ubwo
  ...
  @weekEndSTNormalShiftFirstShiftVessel @sanity @ubwo
  ...
  @weekEndSTNormalShiftSecondShiftVessel @sanity @ubwo
  ...
  @weekEndSTNormalShiftThirdShiftVessel @sanity @ubwo
  ...
  @weekEndOTNormalShiftFirstShiftFourandGo @sanity @ubwo
  ...
  @weekEndOTNormalShiftSecondShiftFourandGo @sanity @ubwo
  ...
  @weekEndOTNormalShiftThirdShiftFourAndGo @sanity @ubwo
  ...
  @weekEndOTNormalShiftFirstShiftPMATraining @sanity @ubwo
  ...
  @weekEndOTNormalShiftSecondShiftPMATraining @sanity @ubwo
  ...
  @weekEndOTNormalShiftThirdShiftPMATraining @sanity @ubwo
...
@leadManNotCheckBox @sanity @ubwo
  ...
  @YT-YardTractor @sanity @bwo @ubwo
  ...
  @weekDaySTNormalShiftApprove @sanity @ubwo1
  ...
  @weekDaySTNormalShiftSTSecondShiftApprove @sanity @ubwo1
  ...
  @weekDaySTNormalShiftSTThirdShiftApprove @sanity @ubwo1
